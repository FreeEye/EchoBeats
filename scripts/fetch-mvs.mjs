...
const SONGS = [
  ...
  // === 郑源 ===
  ["郑源", "一万个理由"], ["郑源", "包容"], ["郑源", "怎么会狠心伤害我"],
  // === 刀郎 ===
  ["刀郎", "冲动的惩罚"], ["刀郎", "西海情歌"], ["刀郎", "披着羊皮的狼"],
  // === 孙燕姿 ===
  ["孙燕姿", "逆光"], ["孙燕姿", "绿光"], ["孙燕姿", "第一天"],
  // === 陶喆 ===
  ["陶喆", "Melody"], ["陶喆", "找自己"], ["陶喆", "普通朋友"],
  // === 李健 ===
  ["李健", "风吹麦浪"], ["李健", "假如爱有天意"],
  // === 莫文蔚 ===
  ["莫文蔚", "他不爱我"], ["莫文蔚", "爱情"],
  ...
  ["梁静茹", "可惜不是你"], ["梁静茹", "崇拜"],
  // === Coldplay ===
  ["Coldplay", "The Scientist"], ["Coldplay", "Clocks"],
  // === Imagine Dragons ===
  ["Imagine Dragons", "Demons"], ["Imagine Dragons", "Thunder"],
]
