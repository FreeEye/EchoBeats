...
`),n=[],r=/\[(\d{2}):(\d{2})\.(\d{2,3})\]/;for(let e of t){let t=e.match(r);if(t){let i=parseInt(t[1],10),a=parseInt(t[2],10),o=parseInt(t[3],10),s=i*60+a+o/(t[3].length===2?100:1e3),c=e.replace(r,``).trim();c&&n.push({time:s,text:c})}}return n.sort((e,t)=>e.time-t.time)}function Nt(){var e;let{isFloatingOpen:t,song:n,lyrics:r,setLyrics:i}=Ye(),a=Je(e=>e.currentTime),o=Z(e=>e.songInPlayer),[s,c]=(0,B.useState)([]),[l,u]=(0,B.useState)(-1),[d,f]=(0,B.useState)(()=>{let e=localStorage.getItem(`lyricsFontSize`);return e?Number(e):jt}),p=(0,B.useRef)(null),m=(0,B.useRef)(null),h=(0,B.useRef)(!1),g=(0,B.useRef)(0),_=(0,B.useRef)(jt),v=(0,B.useRef)(null);(0,B.useEffect)(()=>{let e=t&&o?o:n;t&&e&&e.newId!==v.current&&(v.current=e.newId,c([]),u(-1),R(e).then(e=>{let t=typeof e==`string`?e:e.plainLyrics,n=typeof e==`string`?``:e.syncedLyrics;n?(c(Mt(n)),i(n)):i(t||``)}).catch(()=>{i(``)}))},[t,n==null?void 0:n.newId,o==null?void 0:o.newId]),(0,B.useEffect)(()=>{if(!t||s.length===0)return;function e(){let t=-1;for(let e=s.length-1;e>=0;e--)if(a>=s[e].time){t=e;break}u(t),p.current=requestAnimationFrame(e)}return p.current=requestAnimationFrame(e),()=>{p.current&&cancelAnimationFrame(p.current)}},[t,s,a]);let y=(0,B.useCallback)(e=>{e.preventDefault(),h.current=!0,g.current=e.clientY,_.current=d,document.body.style.cursor=`ns-resize`,document.body.style.userSelect=`none`},[d]);(0,B.useEffect)(()=>{let e=e=>{if(!h.current)return;let t=g.current-e.clientY,n=Math.round(_.current+t/8),r=Math.min(At,Math.max(kt,n));f(r),localStorage.setItem(`lyricsFontSize`,r)},t=()=>{h.current&&(h.current=!1,document.body.style.cursor=``,document.body.style.userSelect=``)};return window.addEventListener(`mousemove`,e),window.addEventListener(`mouseup`,t),()=>{window.removeEventListener(`mousemove`,e),window.removeEventListener(`mouseup`,t)}},[]);let ee=(0,B.useCallback)(e=>{e.touches.length===1&&(h.current=!0,g.current=e.touches[0].clientY,_.current=d)},[d]);(0,B.useEffect)(()=>{let e=e=>{if(!h.current)return;let t=g.current-e.touches[0].clientY,n=Math.round(_.current+t/8),r=Math.min(At,Math.max(kt,n));f(r),localStorage.setItem(`lyricsFontSize`,r)},t=()=>{h.current=!1};return window.addEventListener(`touchmove`,e,{passive:!0}),window.addEventListener(`touchend`,t),()=>{window.removeEventListener(`touchmove`,e),window.removeEventListener(`touchend`,t)}},[]);let te=()=>{let e=Math.min(At,d+2);f(e),localStorage.setItem(`lyricsFontSize`,e)},ne=()=>{let e=Math.max(kt,d-2);f(e),localStorage.setItem(`lyricsFontSize`,e)},b=t&&o?o:n;if(!t||!b)return null;let x=s.length>0,S=x&&l>0?s[l-1]:null,C=x&&l>=0?s[l]:null,w=x&&l<s.length-1?s[l+1]:null,T=!x&&r?r.split(`
`).filter(e=>e.trim()&&!/^\[.*\]$/.test(e.trim())):[],E=d,D=Math.round(d*.72),O=d/jt;return(0,W.jsx)(`div`,{style:{position:`fixed`,bottom:74,left:0,right:0,zIndex:1e3,display:`flex`,justifyContent:`center`,padding:`0 16px`},children:(0,W.jsxs)(`div`,{ref:m,style:{background:`rgba(0, 0, 0, 0.55)`,backdropFilter:`blur(16px)`,borderRadius:16,padding:`${Math.round(10*O)}px ${Math.round(20*O)}px`,maxWidth:Math.round(600*O),width:`100%`,textAlign:`center`,border:`1px solid rgba(255, 255, 255, 0.06)`,transition:`padding 0.2s, max-width 0.2s`},children:[(0,W.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,justifyContent:`center`,gap:6,marginBottom:Math.round(6*O)},children:[(0,W.jsx)(L,{size:Math.round(11*O),color:`#FFA500`}),(0,W.jsxs)(`span`,{style:{fontSize:Math.round(10*O),color:`#8c8c8c`,fontWeight:500},children:[b.name,` - `,((e=b.artists)==null?void 0:e.map(e=>e.name).join(`/`))||`未知`]}),(0,W.jsxs)(`div`,{style:{display:`flex`,gap:2,marginLeft:8,pointerEvents:`auto`},children:[(0,W.jsx)(`button`,{onClick:ne,style:{background:`rgba(255,255,255,0.08)`,border:`none`,borderRadius:4,cursor:`pointer`,display:`flex`,alignItems:`center`,padding:2,color:`#8c8c8c`},onMouseEnter:e=>{e.currentTarget.style.color=`#fff`,e.currentTarget.style.background=`rgba(255,255,255,0.15)`},onMouseLeave:e=>{e.currentTarget.style.color=`#8c8c8c`,e.currentTarget.style.background=`rgba(255,255,255,0.08)`},title:`缩小字体`,children:(0,W.jsx)(F,{size:Math.round(12*O)})}),(0,W.jsx)(`button`,{onClick:te,style:{background:`rgba(255,255,255,0.08)`,border:`none`,borderRadius:4,cursor:`pointer`,display:`flex`,alignItems:`center`,padding:2,color:`#8c8c8c`},onMouseEnter:e=>{e.currentTarget.style.color=`#fff`,e.currentTarget.style.background=`rgba(255,255,255,0.15)`},onMouseLeave:e=>{e.currentTarget.style.color=`#8c8c8c`,e.currentTarget.style.background=`rgba(255,255,255,0.08)`},title:`放大字体`,children:(0,W.jsx)(M,{size:Math.round(12*O)})})]}),(0,W.jsx)(`span`,{style:{fontSize:10,color:`rgba(255,255,255,0.2)`,marginLeft:4},children:`拖动歌词区域缩放`})]}),(0,W.jsx)(`div`,{onMouseDown:y,onTouchStart:ee,style:{cursor:`ns-resize`,minHeight:60},children:x?(0,W.jsxs)(`div`,{children:[S&&(0,W.jsx)(`div`,{style:{fontSize:D,color:`rgba(255,255,255,0.3)`,transition:`all 0.3s`,lineHeight:1.7,marginBottom:2},children:S.text}),C&&(0,W.jsx)(`div`,{style:{fontSize:E,fontWeight:700,color:`#FFA500`,transition:`all 0.3s`,textShadow:`0 0 12px rgba(255,165,0,0.4)`,lineHeight:1.5,padding:`2px 0`},children:C.text}),w&&(0,W.jsx)(`div`,{style:{fontSize:D,color:`rgba(255,255,255,0.3)`,transition:`all 0.3s`,lineHeight:1.7,marginTop:2},children:w.text}),!C&&!S&&w&&(0,W.jsx)(`div`,{style:{fontSize:D,color:`rgba(255,255,255,0.3)`,lineHeight:1.7},children:w.text})]}):T.length>0?(0,W.jsx)(`div`,{style:{maxHeight:120,overflow:`hidden`},children:T.slice(0,4).map((e,t)=>(0,W.jsx)(`div`,{style:{fontSize:D,color:`rgba(255,255,255,0.4)`,lineHeight:1.7},children:e},t))}):(0,W.jsx)(`div`,{style:{fontSize:D,color:`rgba(255,255,255,0.25)`,padding:`6px 0`},children:`暂无歌词`})})]})})}var Pt=class extends B.Component{constructor(e){super(e),this.state={hasError:!1}}static getDerivedStateFromError(e){return{hasError:!0}}componentDidCatch(e,t){console.error(`ErrorBoundary caught an error:`,e,t)}render(){return this.state.hasError?(0,W.jsxs)(`div`,{style:{padding:`40px 20px`,textAlign:`center`,backgroundColor:`#f5f5f5`,borderRadius:`8px`,margin:`20px`},children:[(0,W.jsx)(`h3`,{style:{color:`#ff4d4f`,marginBottom:`16px`},children:`页面出现了错误`}),(0,W.jsx)(`p`,{style:{color:`#666`,marginBottom:`20px`},children:`抱歉，遇到了一些问题。请尝试刷新页面。`}),(0,W.jsx)(`button`,{onClick:()=>window.location.reload(),style:{padding:`8px 16px`,backgroundColor:`#1890ff`,color:`white`,border:`none`,borderRadius:`4px`,cursor:`pointer`},children:`刷新页面`})]}):this.props.children}},Ft=(0,B.lazy)(()=>x(()=>import(`./Home-Czt0N48p.js`),__vite__mapDeps([5,1,2,3,4,6,7,8,9,10]),import.meta.url)),It=(0,B.lazy)(()=>x(()=>import(`./Search-DO5zTp_S.js`),__vite__mapDeps([11,1,2,3,4,6,7,8]),import.meta.url)),Lt=(0,B.lazy)(()=>x(()=>import(`./Playlists-DUCQoYG7.js`),__vite__mapDeps([12,1,2,3,4]),import.meta.url)),Rt=(0,B.lazy)(()=>x(()=>import(`./PlaylistView-DWHUG_Nl.js`),__vite__mapDeps([13,1,2,3,4,7,8]),import.meta.url)),zt=(0,B.lazy)(()=>x(()=>import(`./NewSongs-D4iD_njU.js`),__vite__mapDeps([14,1,2,3,4,6,7,8,9,10]),import.meta.url)),Bt=(0,B.lazy)(()=>x(()=>import(`./Artists-CbGx3pdy.js`),__vite__mapDeps([15,1,2,3,4,9,10]),import.meta.url)),Vt=(0,B.lazy)(()=>x(()=>import(`./ArtistView-BzjbFr3t.js`),__vite__mapDeps([16,1,2,3,4,6,7,8,9,10]),import.meta.url)),Ht=(0,B.lazy)(()=>x(()=>import(`./MVPage-D4kdBjP5.js`),__vite__mapDeps([17,1,2,3,4]),import.meta.url)),Ut=(0,B.lazy)(()=>x(()=>import(`./Favorites-D6N3-U92.js`),__vite__mapDeps([18,1,2,3,4,6,7,8]),import.meta.url)),{Content:Wt}=l;function Gt(){let e=ze(e=>e.isListenlistOpen);return(0,W.jsx)(Pt,{children:(0,W.jsx)(S,{children:(0,W.jsx)(ee,{theme:{algorithm:h.darkAlgorithm,token:{colorPrimary:`#FFA500`,colorLink:`#ffffff`,colorLinkHover:`orange`},components:{Menu:{itemPaddingInline:10}}},children:(0,W.jsxs)(l,{children:[(0,W.jsx)(Ne,{}),(0,W.jsx)(Wt,{className:`container`,style:{marginTop:90,marginBottom:74},children:(0,W.jsx)(B.Suspense,{fallback:(0,W.jsx)(Tt,{}),children:(0,W.jsxs)(te,{children:[(0,W.jsx)(b,{path:`/`,element:(0,W.jsx)(Ft,{})}),(0,W.jsx)(b,{path:`search/:keyword`,element:(0,W.jsx)(It,{})}),(0,W.jsx)(b,{path:`playlists`,element:(0,W.jsx)(Lt,{})}),(0,W.jsx)(b,{path:`playlist/:id`,element:(0,W.jsx)(Rt,{})}),(0,W.jsx)(b,{path:`new-songs`,element:(0,W.jsx)(zt,{})}),(0,W.jsx)(b,{path:`artists`,element:(0,W.jsx)(Bt,{})}),(0,W.jsx)(b,{path:`artist/:name`,element:(0,W.jsx)(Vt,{})}),(0,W.jsx)(b,{path:`mv`,element:(0,W.jsx)(Ht,{})}),(0,W.jsx)(b,{path:`favorites`,element:(0,W.jsx)(Ut,{})})]})})}),(0,W.jsx)(Ct,{}),e&&(0,W.jsx)(Dt,{}),(0,W.jsx)(Ot,{}),(0,W.jsx)(Nt,{})]})})})})}var Kt={LISTENLIST:`listenlist`,PLAY_INDEX:`playIndex`,PLAY_MODE:`playMode`,VOLUME:`volume`},qt=(e,t=null)=>{try{let n=localStorage.getItem(e);if(n===null)return t;try{return JSON.parse(n)}catch(e){return n}}catch(n){return console.warn(`Failed to get item from localStorage: ${e}`,n),t}},Jt=(e,t)=>{try{let n=typeof t==`string`?t:JSON.stringify(t);return localStorage.setItem(e,n),!0}catch(t){return console.warn(`Failed to set item in localStorage: ${e}`,t),!1}},Yt=()=>qt(Kt.LISTENLIST,[]),Xt=e=>Jt(Kt.LISTENLIST,e),Zt=()=>{let e=qt(Kt.PLAY_INDEX,0);return typeof e==`number`?e:parseInt(e)||0},Qt=e=>Jt(Kt.PLAY_INDEX,e.toString()),$t=(0,B.createContext)(),en=({children:e})=>{let[t,n]=(0,B.useState)(()=>Yt()),[r,i]=(0,B.useState)(()=>Zt()),a=t[r],o=e=>{Xt(e)},s=e=>{Qt(e)},c=e=>{n(t=>{if(t.some(t=>t.newId===e.newId))return t;let n=[...t,e];return o(n),n})},l=e=>{n(t=>{let n=e.filter(e=>t.every(t=>t.newId!==e.newId)),r=t.concat(n);return o(r),r})},u=e=>{n(e),o(e)},d=e=>{n(t=>{let n=[...t];return n.splice(e,1),o(n),n})},f=()=>{n([]),o([])},p=e=>{i(e),s(e)},m=()=>{i(0),s(0)};(0,B.useEffect)(()=>{s(r)},[r]);let h={listenlist:t,playIndex:r,currentSong:a,addSongToListenlist:c,addSongsToListenlist:l,setNewListenlist:u,deleteSongInListenlist:d,clearListenlist:f,updatePlayIndex:p,clearPlayIndex:m};return(0,W.jsx)($t.Provider,{value:h,children:e})};((...e)=>e.reduce((e,t)=>({children:n})=>(0,W.jsx)(e,{children:(0,W.jsx)(t,{children:n})}),({children:e})=>(0,W.jsx)(W.Fragment,{children:e})))(en,ke),(0,be.createRoot)(document.getElementById(`root`)).render((0,W.jsx)(({children:e})=>(0,W.jsx)(en,{children:(0,W.jsx)(ke,{children:e})}),{children:(0,W.jsx)(Gt,{})}));export{$ as a,Z as c,De as d,Oe as f,ft as i,J as l,vt as n,tt as o,Ee as p,_t as r,Q as s,Tt as t,Pe as u};